...
{         
  ...
  //  private float delta = 0.005f;
    ...
    public void ApplyTexturesToMesh(Material material,Vector3[] vertices, Vector3[] normals, int[] triangles, BiomBlendType biomBlendType)
    {
      ...
      //  int[] triangles = mesh.triangles;
        ...
        */
        ...
        /*    foreach(var biome in biomeCollection.biomes)
            {
                biome.heightMask = CreateBiomesAttributeMaskHeight(biome);
                biome.tempMask= CreateBiomesAttributeMaskTemperature(biome);
                biome.slopeMask = CreateBiomesAttributeMaskSlope(biome);
            }*/
        ...
        //  List<int> biomesPerVertex = GetBiomeForEachVertex(vertices, normals, numVertices);
        ...
        Debug.Log("Biom selection Duration in milliseconds: " + duration.Milliseconds);
    ...
    private Mesh BuildNewMeshDiscrete(Vector3[] vertices, Vector3[] normals, NativeArray<int> biomesPerVertex)
    {
        ...
        var job2 = new FlattenTrianglesJob
        {
    ...
    private NativeArray<int> GetBiomeForEachVertexParalel(Vector3[] vertices, Vector3[] normals)
    {
        ...
        AssignBiomeJob job = new AssignBiomeJob
        {
            heights = heightsNA,
